...
const EVENT_ANNOUNCEMENT_MESSAGES = [["<:VC_Firework:1470796227913322658> **ACTIVITY EXP EVENT**", "", "> <a:VC_HeartsPink:1468685897389052008> __Per festeggiare i 350 membri abbiamo deciso di startare un nuovo evento!__", "> <a:VC_HeartsBlue:1468686100045369404> **Non sarà il classico activity event, ma sarà incentrato tanto sull'exp e i livelli.**", "", "<a:VC_Sparkles:1468546911936974889> Ogni ruolo ottenibile **gratuitamente** avrà una __ricompensa extra__ oltre a quelle già scritte in <#1442569111119990887>:", "<:VC_DoubleReply:1482532332509466797> <@&1469040179799920801> / <@&1469040190730408018> <a:VC_Arrow:1448672967721615452> __Facendo la verifica tramite selfie otterrete anche 5 livelli__", "<:VC_DoubleReply:1482532332509466797> <@&1442568948271943721> <a:VC_Arrow:1448672967721615452> __Mettendo il nostro link nello status (discord.gg/viniliecaffe) riceverete 5 livelli__", "<:VC_DoubleReply:1482532332509466797> <@&1468266342682722679> <a:VC_Arrow:1448672967721615452> __Votando ogni giorno su [Discadia](<https://discadia.com/vote/viniliecaffe/>) ricevete 1 livello__", "<:VC_DoubleReply:1482532332509466797> <@&1469758545263198442> / <@&1474357579143577610> / <@&1474361806956007425> <a:VC_Arrow:1448672967721615452> __Per ogni soglia di inviti fatti col vostro [custom link](<https://imgur.com/a/3wpDOVj>) raggiunta riceverete rispettivamente 5 livelli, 10 livelli e 25 livelli.__", "<:VC_Reply:1482532158080942191> <@&1471955147692179497> <a:VC_Arrow:1448672967721615452> __Mettendo una nostra <#1475223034057982184> riceverete 10 livelli__",].join("\n"), ["", "<:VC_EXP:1482534670896730143> Inoltre ci sarà un __multi globale__ di **x3** per tutti. Alcuni ruoli avranno anche dei boost **maggiorati** per tutta la durata dell'evento:", "<:VC_DoubleReply:1482532332509466797> <@&1329497467481493607> <a:VC_Arrow:1448672967721615452> __`x3` invece di `x2`__", "<:VC_DoubleReply:1482532332509466797> <@&1442568916114346096> <a:VC_Arrow:1448672967721615452> __`x4` invece di `x3`__", "<:VC_DoubleReply:1482532332509466797> <@&1442568950805430312> <a:VC_Arrow:1448672967721615452> __`x5` invece di `x4`__", "<:VC_Reply:1482532158080942191> <@&1469073503025103113> <a:VC_Arrow:1448672967721615452> __Per premiare anche chi sta qui da più tempo applicheremo un boost extra di `x2`__", "> <a:VC_Exclamation:1482534702077444217> __Ricordo che questi boost si sommano a quello globale, non tra di loro.__",].join("\n"), (startDateStr, endDateStr) => ["", "<a:VC_Events:1448688007438667796> Ogni settimana i 3 utenti più attivi in vocale e in testuali riceveranno rispettivamente le seguenti ricompense:", "<:VC_DoubleReply:1482532332509466797> **1° Settimana** <a:VC_Arrow:1448672967721615452> __10 livelli__", "<:VC_DoubleReply:1482532332509466797> **2° Settimana** <a:VC_Arrow:1448672967721615452> __Un colore gradiente a scelta__", "<:VC_DoubleReply:1482532332509466797> **3° Settimana** <a:VC_Arrow:1448672967721615452> __Ruolo custom e vocale privata permanente__", "<:VC_Reply:1482532158080942191> **4° Settimana** <a:VC_Arrow:1448672967721615452> __Ruolo <@&1442568950805430312> permanente__", "> <a:VC_Exclamation:1482534702077444217> __Ricordo che inoltre i primi in top testuale e vocale riceveranno lo stesso <@&1468674837957574757> e <@&1468674787399172208> ogni settimana.__", "", "<a:VC_Boost:1448670271115497617> Alla fine dell'evento verrà stilata una classifica globale in base all'**EXP** (__non ai livelli__) ottenuta durante la durata dell'evento e i primi 3 otterranno un **__NITRO BOOST__**.", "", "> **NB: Tutti i premi vengono assegnati automaticamente dal bot, anche quelli settimanali (naturalmente non i Nitro Boost), aprite un <#1442569095068254219> solo se siete sicuri di non aver ricevuto la vostra ricompensa. Tutti i ticket inutili verranno sanzionati.**", "", `<a:VC_Calendar:1448670320180592724> __La durata dell'evento è dal \`${startDateStr}\` al \`${endDateStr}\`__`, "", "<a:VC_Ping:1448670620412809298>︲<@&1442569012063109151>",].join("\n"),];
...
function buildStaffEventAnnouncementMessages(startDateStr, endDateStr) {
  const part1 = ["## <a:VC_Announce:1482534613568979007>  **EVENTO STAFF**", "", "> <a:VC_Cross:1482532424570376253> __Lo <@&1442568910070349985> non può partecipare all'activity event__", "> <a:VC_Diamon:1469463765610135635> __Per lo Staff ci sarà un evento parallelo a quello degli utenti__", "", "<:VC_InactiveStatus:1472011031709745307> __Ogni staff per tutta la durata avrà una graduatoria che gli farà garantire un punteggio:__", "<:VC_DoubleReply:1482532332509466797> **Ogni utente entrato tramite invito col vostro [custom link](<https://imgur.com/a/3wpDOVj>) **<a:VC_Arrow:1448672967721615452> __1 punto__", "<:VC_DoubleReply:1482532332509466797> **Ogni utente che si candiderà grazie a voi** <a:VC_Arrow:1448672967721615452> __5 punti__", "<:VC_DoubleReply:1482532332509466797> **Ogni utente che boosta grazie a voi**  <a:VC_Arrow:1448672967721615452> __10 punti__", "<:VC_DoubleReply:1482532332509466797> **Fare il <@&1442568905582317740> oltre allo <@&1442568910070349985>** <a:VC_Arrow:1448672967721615452> __15 punti__", "<:VC_DoubleReply:1482532332509466797> **Ogni server che si trasferirà nel nostro** <a:VC_Arrow:1448672967721615452> __20 punti__", "<:VC_DoubleReply:1482532332509466797> **Superare ogni settimana i limiti di almeno 150 messaggi e 1h e 30** <a:VC_Arrow:1448672967721615452> __20 punti__", "<:VC_DoubleReply:1482532332509466797> **Ogni server che chiede una <#1442569211611185323> grazie a voi** <a:VC_Arrow:1448672967721615452> __25 punti__", "<:VC_Reply:1482532158080942191> **Ogni utente che compra il <@&1442568950805430312> o il <@&1442568916114346096> grazie a voi** <a:VC_Arrow:1448672967721615452> __50 punti__", "> <a:VC_Alert:1448670089670037675> __NB: L'utente che si candiderà dovrà essere pexato al fine del conteggio dei punti. Per le prove dovrete aprire un <#1442569095068254219> `terza categoria`.__", "> <:VC_BlackPin:1482534513400610948> __L'<@&1442568894349840435> è escluso dall'evento__",].join("\n");
  const part2 = ["", "<:VC_Attention:1482534443632558151> **Alla fine dell'evento verranno comunicati lo staffer con più punti (candidato al pex) e quello con meno punti (candidato al depex); pex e depex saranno assegnati manualmente dallo staff.**", "", `<a:VC_pixeltime:1482535344103620771> __La durata dell'evento è dal \`${startDateStr}\` al \`${endDateStr}\`__`, "", "<:VC_Mention:1482526855289634997>︲<@&1442568910070349985>",].join("\n");
  return [part1, part2];
}
...
module.exports = {
  ...
  async execute(message, args = []) {
    ...
    if (sub === "assegna-ruoli") {
      ...
      await safeMessageReply(message, {
        content: "<:VC_EXP:1482534670896730143> Assegnazione livelli avviata in background (può richiedere diversi minuti). Ti avviso quando ha finito.",
        allowedMentions: { repliedUser: false },
      }).catch(() => { });
    ...
    if (sub === "reset-premi") {
      ...
      invalidateSettingsCache(guildId);
      await safeMessageReply(message, {
        content: "<:VC_EXP:1482534670896730143> Reset premi avviato in background (cancellati " + deleted + " registri; riassegnazione può richiedere diversi minuti). Ti avviso quando ha finito.",
        allowedMentions: { repliedUser: false },
      }).catch(() => { });
      (async () => {
        try {
    ...
    if (sub === "info") {
      ...
      if (diag) {
        ...
        if (diag.eventWeek >= 1 && diag.eventWeek <= 4 && diag.activityDailyCount === 0) {
          lines.push("", "<:VC_InactiveStatus:1472011031709745307> Se nessuno viene calcolato: il bot deve essere online quando scrivono; i canali dove scrivono devono dare al ruolo Member **Visualizza canale** e **Invia messaggi**. Controlla che la chat principale non sia esclusa.");
        }
      }
    ...
    if (sub === "start") {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          [
            `<:VC_EXP:1482534670896730143> **ACTIVITY EXP EVENT**`,
            ``,
