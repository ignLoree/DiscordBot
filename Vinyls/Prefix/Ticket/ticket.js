...
function getTicketPanelConfig(raw) {
  ...
  const configs={supporto:{type:"supporto",emoji:"⭐",name:"supporto",label:"Supporto",embed:new EmbedBuilder().setTitle("<:vsl_ticket:1329520261053022208> • **__TICKET SUPPORTO__**").setDescription(`<a:ThankYou:1329504268369002507> • __Grazie per aver aperto un ticket!__\n\n<a:loading:1443934440614264924> 🠆 Attendi un membro dello **__\`STAFF\`__**.\n\n<:reportmessage:1443670575376765130> ➥ Descrivi supporto, segnalazione o problema in modo chiaro.`,).setColor("#6f4e37"),},partnership:{type:"partnership",emoji:"🤝",name:"partnership",label:"Partnership",embed:new EmbedBuilder().setTitle("<:vsl_ticket:1329520261053022208> • **__TICKET PARTNERSHIP__**",).setDescription(`<a:ThankYou:1329504268369002507> • __Grazie per aver aperto un ticket!__\n\n<a:loading:1443934440614264924> 🠆 Attendi un **__\`PARTNER MANAGER\`__**.\n\n<:reportmessage:1443670575376765130> ➥ Manda la descrizione del tuo server/catena tramite il bottone qui in basso.`,).setColor("#6f4e37"),},highstaff:{type:"high",emoji:"✨",name:"highstaff",label:"High Staff",embed:new EmbedBuilder().setTitle("<:vsl_ticket:1329520261053022208> • **__TICKET HIGH STAFF__**",).setDescription(`<a:ThankYou:1329504268369002507> • __Grazie per aver aperto un ticket!__\n\n<a:loading:1443934440614264924> 🠆 Attendi un **__\`HIGH STAFF\`__**.\n\n<:reportmessage:1443670575376765130> ➥ Specifica se riguarda Verifica Selfie, Donazioni, Sponsor o HighStaff.`,).setColor("#6f4e37"),},};
...
module.exports = {
  ...
  subcommandAliases: {
    ...
    ticketcloserequest: "closerequest",
  },
      ...
      if (!ticketPrefix) {
        await safeMessageReply(message, {
          embeds: [
            makeErrorEmbed(
              "Errore",
              "<:vegax:1443934876440068179> Nome canale ticket non valido: non riesco a ricostruire il prefisso.",
            ),
          ],
          allowedMentions: { repliedUser: false },
        });
