...
module.exports = {
  ...
  description: "Mostra le statistiche attività di un utente tramite ID (1d/7d/14d/21d/30d).",
  usage: "+user <userId> [1d|7d|14d|21d|30d]",
  examples: ["+user 123456789012345678", "+user 123456789012345678 30d"],
  ...
  async execute(message, args = []) {
    ...
    const { targetId, lookbackDays } = userButton.parseUserActivityArgs(args);
    if (!targetId) {
      await safeMessageReply(message, {
        content: "<:vegax:1443934876440068179> Usa: `+user <userId> [1d|7d|14d|21d|30d]`",
