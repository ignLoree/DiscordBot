...
const PREFIX_HELP_DESCRIPTIONS = {
  ...
  server: 'Mostra statistiche e attività del server (messaggi, vocali, top utenti e canali).',
  ...
  restart: 'Riavvia il bot o ricarica moduli specifici (handlers, commands, prefix, events, triggers, services, utils, schemas).',
  ...
  level: 'Gestisce il sistema livelli: set, add, remove, reset, lock, unlock, multiplier, ignore, unignore.',
