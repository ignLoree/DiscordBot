...
function buildErrorLogEmbed({
  ...
  const errorInBlock=fullError.length>ERROR_TEXT_MAX?`${fullError.slice(0,ERROR_TEXT_MAX)}...`
      : fullError;
  ...
  const fields=[{name:`<:dot:1443660294596329582> ${safeLabel}`,
      value: `\`\`\`${safeContext}\`\`\``,},{name:"<:dot:1443660294596329582> Server",value:`\`\`\`${safeServer}\`\`\``,},{name:"<:dot:1443660294596329582> Utente",value:`\`\`\`${safeUserTag}\`\`\``,},{name:"<:dot:1443660294596329582> Errore",value:`\`\`\`${errorInBlock}\`\`\``,},];
