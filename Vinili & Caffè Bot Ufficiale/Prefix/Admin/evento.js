...
const EVENT_ANNOUNCEMENT_MESSAGES = [
  [
    "<:VC_Firework:1470796227913322658> **ACTIVITY EXP EVENT**",
    "",
    "> <a:VC_HeartsPink:1468685897389052008> __Per festeggiare i 350 membri abbiamo deciso di startare un nuovo evento!__",
    "> <a:VC_HeartsBlue:1468686100045369404> **Non sarà il classico activity event, ma sarà incentrato tanto sull'exp e i livelli.**",
    "",
    "<a:VC_Sparkles:1468546911936974889> Ogni ruolo ottenibile **gratuitamente** avrà una __ricompensa extra__ oltre a quelle già scritte in <#1442569111119990887>:",
    "<:VC_DoubleReply:1468713981152727120> <@&1469040179799920801> / <@&1469040190730408018> <a:VC_Arrow:1448672967721615452> __Facendo la verifica tramite selfie otterrete anche 5 livelli__",
    "<:VC_DoubleReply:1468713981152727120> <@&1442568948271943721> <a:VC_Arrow:1448672967721615452> __Mettendo il nostro link nello status (discord.gg/viniliecaffe) riceverete 5 livelli__",
  ...
  [
    ...
    "<:VC_DoubleReply:1468713981152727120> <@&1442568916114346096> <a:VC_Arrow:1448672967721615452> __`x4` invece di `x3`__",
    "<:VC_DoubleReply:1468713981152727120> <@&1442568950805430312> <a:VC_Arrow:1448672967721615452> __`x5` invece di `x4`__",
    "<:VC_Reply:1468262952934314131> <@&1469073503025103113> <a:VC_Arrow:1448672967721615452> __Per premiare anche chi sta qui da più tempo applicheremo un boost extra di `x2`__",
    "> <a:VC_Exclamation:1448687427836444854> __Ricordo che questi boost si sommano a quello globale, non tra di loro.__",
  ].join("\n"),
  (startDateStr, endDateStr) =>
    [
      "",
      "<a:VC_Events:1448688007438667796> Ogni settimana i 3 utenti più attivi in vocale e in testuali riceveranno rispettivamente le seguenti ricompense:",
      "<:VC_DoubleReply:1468713981152727120> **1° Settimana** <a:VC_Arrow:1448672967721615452> __10 livelli__",
      "<:VC_DoubleReply:1468713981152727120> **2° Settimana** <a:VC_Arrow:1448672967721615452> __Un colore gradiente a scelta__",
      "<:VC_DoubleReply:1468713981152727120> **3° Settimana** <a:VC_Arrow:1448672967721615452> __Ruolo custom e vocale privata permanente__",
      "<:VC_Reply:1468262952934314131> **4° Settimana** <a:VC_Arrow:1448672967721615452> __Ruolo <@&1442568950805430312> permanente__",
      "> <a:VC_Exclamation:1448687427836444854> __Ricordo che inoltre i primi in top testuale e vocale riceveranno lo stesso <@&1468674837957574757> e <@&1468674787399172208> ogni settimana.__",
      "",
...
function buildStaffEventAnnouncementMessages(startDateStr, endDateStr) {
  const part1 = [
    ...
    "> <a:VC_Diamon:1469463765610135635> __Per lo Staff ci sarà un evento parallelo a quello degli utenti__",
    "",
    "<:VC_Info:1460670816214585481> __Ogni staff per tutta la durata avrà una graduatoria che gli farà garantire un punteggio:__",
    "<:VC_DoubleReply:1468713981152727120> **Ogni utente entrato tramite invito col vostro [custom link](<https://imgur.com/a/3wpDOVj>) **<a:VC_Arrow:1448672967721615452> __1 punto__",
    "<:VC_DoubleReply:1468713981152727120> **Ogni utente che si candiderà grazie a voi** <a:VC_Arrow:1448672967721615452> __5 punti__",
    "<:VC_DoubleReply:1468713981152727120> **Ogni utente che boosta grazie a voi**  <a:VC_Arrow:1448672967721615452> __10 punti__",
    "<:VC_DoubleReply:1468713981152727120> **Fare il <@&1442568905582317740> oltre allo <@&1442568910070349985>** <a:VC_Arrow:1448672967721615452> __15 punti__",
    "<:VC_DoubleReply:1468713981152727120> **Ogni server che si trasferirà nel nostro** <a:VC_Arrow:1448672967721615452> __20 punti__",
    "<:VC_DoubleReply:1468713981152727120> **Superare ogni settimana i limiti di almeno 150 messaggi e 1h e 30** <a:VC_Arrow:1448672967721615452> __20 punti__",
  ...
  async execute(message, args = []) {
    ...
    if (sub === "classifica") {
      ...
      if (second === "staff") {
        ...
        const lines = leaderboard.length
          ? leaderboard.map((r, i) => `${i + 1}. <@${r.userId}> — **${r.points}** pt`)
    ...
    if (sub === "staff") {
      ...
      if (staffSub === "start") {
        ...
        const result = await setStaffEvent(guildId, {
    ...
    if (sub === "info") {
      ...
      const embed = new EmbedBuilder()
        .setColor("#6f4e37")
        .setTitle("Stato evento Activity EXP")
        .setDescription(lines.join("\n"));
      await safeMessageReply(message, {
        embeds: [embed],
        allowedMentions: { repliedUser: false },
    ...
    if (sub === "start") {
      const now = new Date();
      const endDate = getEndDateAt21Rome(now, EVENT_DURATION_DAYS - 1);
      const result = await setActivityEvent(guildId, {
        startDate: now.getTime(),
        endDate: endDate.getTime(),
        startedAt: now,
        globalMultiplier: EVENT_GLOBAL_MULTI,
        roleOverrides: EVENT_ROLE_OVERRIDES,
        extraMultiplierRoleIds: EVENT_EXTRA_MULTI_ROLE_IDS,
      });
      if (!result) {
        await safeMessageReply(message, {
      ...
      if (NEWS_CHANNEL_ID) {
        const newsChannel =
          message.client.channels.cache.get(NEWS_CHANNEL_ID) ||
          (await message.client.channels.fetch(NEWS_CHANNEL_ID).catch(() => null));
        if (newsChannel) {
          ...
          for (let i = 0; i < EVENT_ANNOUNCEMENT_MESSAGES.length; i++) {
            const content =
              typeof EVENT_ANNOUNCEMENT_MESSAGES[i] === "function"
                ? EVENT_ANNOUNCEMENT_MESSAGES[i](startStr, endStr)
                : EVENT_ANNOUNCEMENT_MESSAGES[i];
            await newsChannel
              .send({
                content,
