            ...
            if (group === "positiva") {
                ...
                if (sub === "remove") {
                    ...
                    const embed = new EmbedBuilder()
                        ...
                        .setDescription(`<:reportmessage:1443670575376765130> A __${utentee}__ ши stata **rimossa** una _Valutazione Positiva!_`)
                        .addFields(
            ...
            if (group === "negativa") {
                ...
                if (sub === "remove") {
                    ...
                    const embed = new EmbedBuilder()
                        ...
                        .setDescription(`<:reportmessage:1443670575376765130> A __${utentee}__ ш stata **rimossa** una _Valutazione Negativa!_`)
                        .addFields(
                            { name: "Motivazione:", value: `${reason}`, inline: false },
