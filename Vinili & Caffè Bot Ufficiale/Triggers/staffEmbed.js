...
module.exports = {
    ...
    async execute(client) {
        ...
        const moderazione = client.channels.cache.get('1442569243626307634');
        const beststaff = client.channels.cache.get('1442569253281730653');
        const guidastaff = client.channels.cache.get('1442569237142044773');
        const staffpagato = client.channels.cache.get('1442579412280410194');
  ...
  <:dot:1443660294596329582> **__5__ giorni** di __pausa__ aggiuntivi`),
        ...
        <:dot:1443660294596329582> **__\`5\`__** <a:vegarightarrow:1443673039156936837> Ogni volta che si __oltrepassa__ il numero di **sanzioni ottenibili** si **ricomincia** il __ciclo__ di sanzioni per quella **specifica __regola__**.`),
            new EmbedBuilder()
                ...
                > Per riscattare eventuali premi bisognerà aprire un <#1442569095068254219> **__\`HIGH STAFF\`__**
