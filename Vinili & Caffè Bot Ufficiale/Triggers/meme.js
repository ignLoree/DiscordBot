        ...
        try {
            ...
            if (message.content === ("firenze") && message.author.id === '295500038401163264') {
                ...
                message.channel.send({content: `
                                Poesia per Natale
                Se nì mondo esistesse un po' di bene
