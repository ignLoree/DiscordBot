...
temporaryCommandPermissionSchema.index({ expiresAt: 1 }, { expireAfterSeconds: 0 });

module.exports = models.temporary_command_permission || model('temporary_command_permission', temporaryCommandPermissionSchema);
